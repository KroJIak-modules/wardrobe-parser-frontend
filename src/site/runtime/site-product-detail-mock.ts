    ...
    gallery: [
      {
        ...
        thumbWidth: 95,
        thumbHeight: 127,
        alt: "Heavy Flight Shearling Hoodie Black",
      },
    ],
  },
  {
...
export function getSiteProductRecommendations(product: SiteProductDetailItem, limit = 8) {
  const figmaRecommendationsByProductId: Record<string, readonly string[]> = {
    "product-trucker": [
      ...
      "product-heavy-flight-shearling",
      "product-saarland-grey",
      "product-moto-couture",
      "product-slim-low-waist",
      "product-colossous-camo",
      "product-swarovski-belt",
    ],
  };
