...
export function AdminSettingsTransferSection({
  ...
  return (
    <>
      ...
      <p className="muted">
        Экспортируются все переносимые настройки: роли и права, текстовый контент сайта и пароль доступа, ценообразование, поставщики, источники и их конфигурация, правила веса и структура каталога.
        Товары, бренды и дизайнеры каталога, изображения и другое медиа, пользователи, пароли администраторов, история синхронизаций и ручные привязки товаров не переносятся.
      </p>
      ...
      {pendingImport ? (
        <div className="modal-backdrop" onClick={onCancelImportSettings}>
          <div className="modal modal--danger-confirm" onClick={(event) => event.stopPropagation()}>
            ...
            <p className="muted">
              Импорт заменит настройки на сервере: источники, тарифы, правила веса, структуру каталога и текстовый контент. Бренды и дизайнеры каталога, изображения и другое медиа не затрагиваются. Отсутствующие в файле источники и тарифы будут удалены. Файл содержит пароль доступа к сайту в открытом виде.
            </p>
            <div className="settings-transfer-actions">
      ...
      {resetConfirmOpen ? (
        <div className="modal-backdrop" onClick={onCancelResetSettings}>
          <div className="modal modal--danger-confirm" onClick={(event) => event.stopPropagation()}>
            ...
            <p className="muted">
              Сброс заменит цены, тарифы, настройки источников, правила веса, пароль сайта, текст «Обо мне» и FAQ значениями по умолчанию. Бренды и дизайнеры каталога не затрагиваются. Это действие необратимо.
            </p>
            <div className="settings-transfer-actions">
