...
export function AdminSettingsTransferSection({
  ...
  return (
    <>
      ...
      <p className="muted">
        Экспортируются все переносимые настройки: роли и права, текстовый контент сайта и пароль доступа, ценообразование, поставщики, источники и их конфигурация, правила веса, дизайнеры и структура каталога.
        Товары, изображения и другое медиа, пользователи, пароли администраторов, история синхронизаций и ручные привязки товаров не переносятся.
      </p>
      ...
      {pendingImport ? (
        <div className="modal-backdrop" onClick={onCancelImportSettings}>
          <div className="modal modal--danger-confirm" onClick={(event) => event.stopPropagation()}>
            ...
            <p className="muted">
              Импорт заменит настройки на сервере: источники, тарифы, правила веса, структуру каталога и текстовый контент. Изображения и другое медиа не затрагиваются. Отсутствующие в файле источники, тарифы и неиспользуемые дизайнеры будут удалены. Файл содержит пароль доступа к сайту в открытом виде.
            </p>
            <div className="settings-transfer-actions">
