...
export function AdminSettingsTransferSection({
  ...
  return (
    <>
      ...
      <p className="muted">
        Экспортируются контент, ценообразование, поставщики, источники с порядком, правила веса, дизайнеры, фильтры, кастомные каталоги, структура витрины и медиа витрины.
