...
const ColorPicker = ({ size, value, defaultValue = constants_1.DEFAULT_COLOR, onUpdate, open, onOpenChange, defaultOpen = false, withAlpha = false, compact = false, }) => {
    ...
    const updateHsva = React.useCallback((updates) => {
        ...
        if (!(0, utils_1.isValidHsva)(newHsva)) {
            return;
        }
        setHsva(newHsva);
        ...
        if (!(0, react_color_1.validHex)(newHexValue)) {
            return;
        }
    ...
    const applyInputValue = React.useCallback(() => {
        ...
        if (modeState === types_1.Modes.Hex && !(0, react_color_1.validHex)(raw)) {
            setInputValue(color);
            return;
        }
        const newHsva = (0, utils_1.convertSelectedModeColorToHsva)(raw, modeState, withAlpha);
        if (!(0, utils_1.isValidHsva)(newHsva)) {
            setInputValue(color);
            return;
        }
