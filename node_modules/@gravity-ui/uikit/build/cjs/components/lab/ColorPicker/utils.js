...
exports.getTextValueByMode = exports.convertSelectedModeColorToHsva = exports.isValidHsva = void 0;
 ...
 */
const isValidHsva = (hsva) => {
    return (!Number.isNaN(hsva.h) &&
        !Number.isNaN(hsva.s) &&
        !Number.isNaN(hsva.v) &&
        !Number.isNaN(hsva.a) &&
